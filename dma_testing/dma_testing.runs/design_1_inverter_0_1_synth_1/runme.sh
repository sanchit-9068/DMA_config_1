...
HD_PWD='D:/Kishore_Sir_Project/dma_testing/dma_testing.runs/design_1_inverter_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_inverter_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_inverter_0_1.tcl
